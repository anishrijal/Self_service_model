    ...
    <section class="character-data">
        ...
        <div class="character-text">
            ...
            <div class="character-text-right">
                <h6>Individual</h6>
                <p>Select a face form the picture to view individual's metrices</p>
             {{--   <img src="" alt="">--}}
                <canvas id="myCanvas">
                        ...
                        $.each(data.list_a[index], function (d, s) {
                            ...
                            $(".character-text-left").find("#personalData").find("span").on("click", function () {
                                ...
                                $.each(data.list, function (j, m) {
                                    ...
                                    if (m.author.race == 0) {gloyaltyValue = 0} else {gloyaltyValue = gloyaltyconf}
                                });
                                var chart = Highcharts.chart('RunData', {
                                    title: {text: ''},
                                    subtitle: {text: ''},
                                    ...
                                    series: [{
                                        ...
                                        data: [{y: Number(gageValue), color: "#9ae06e"},
                                            ...
                                            {y: Number(gloyaltyValue), color: "#e5bd06"}],
                                        showInLegend: false
                                    }],
                                    plotOptions: {
                                        series: {
